...
function appendQueryToHistoryDisplay(activitesUtilisateur) {
    ...
    // Iterate over each request in activitesUtilisateur.requetes
    activitesUtilisateur.requetes.forEach(requestObj => {
        ...
        // Create the "Save" icon inside the button
        const saveIcon = document.createElement("span");
        saveIcon.className = "save-icon";
        saveIcon.textContent = "💾"; // Unicode character for a floppy disk icon

        saveButton.appendChild(saveIcon);

        // Add click event listener to save activities
        saveButton.addEventListener("click", function() {
            saveUserActivities(activitesUtilisateur); // Pass requestObj to saveUserActivities
            flagTest = true;
        });
