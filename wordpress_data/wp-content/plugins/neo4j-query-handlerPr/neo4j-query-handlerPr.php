<?php
/*
Plugin Name: Neo4j Query HandlerPr
...
function enqueue_neo4j_scripts() {
    ...
    wp_enqueue_script('neo4j-script', plugin_dir_url(__FILE__) . 'path/to/96.js', array('jquery'), '1.0', true);

    // Utilisez wp_localize_script pour passer des variables PHP à votre script JavaScript
    wp_localize_script('neo4j-script', 'neo4jAjax', array(
